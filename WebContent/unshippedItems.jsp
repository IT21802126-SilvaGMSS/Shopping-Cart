	...
	<div class="container-fluid">
		<div class="table-responsive ">
			<table class="table table-hover table-sm" style="margin-top: 20px;">
				<thead
					style="background-color: #0047AB; color: white; font-size: 16px; font-weight: bold;">
					<tr>
						<th>TransactionId</th>
						<th>ProductId</th>
						<th>User Email Id</th>
				...
				<tbody style="background-color: white;">
					...
					<tr>
						...
						<td><%=quantity%></td>
						<td>READY_TO_SHIP</td>
						<td><a href="ShipmentServlet?orderid=<%=order.getTransactionId()%>&amount=<%=order.getAmount()%>&userid=<%=userId%>&prodid=<%=order.getProductId()%>"
       class="btn btn-success"
       style="background-color: green; color: white; ">SHIP NOW</a></td>
