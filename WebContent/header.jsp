...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center" style="margin-top: 45px; padding: 5px;">
    <div class="row">
        <div class="col-xs-9">
            <h2 style="font-family: Garamond, serif; font-size: 44px; font-weight: bold; color: #33cc33; margin-left: 380px;">Green Store</h2>
        </div>
        <div class="col-xs-3 text-right">
            <form class="form-inline" action="index.jsp" method="get" style="margin-top: 30px; margin-right: 50px;">
